...
5. Extract the portable version of ReciPro (`ReciPro-v.4.937-win-x64-portable.zip`) and place the `ReciPro` folder in Contents/SharedSupport/prefix/drive_c.
...
## Known issues
- Some letters and arrows are not displayed correctly. Installing `fakejapanese_ipamona` via winetricks is effective for showing some angstrom signs, but it does not fully solve problems under my environment.
